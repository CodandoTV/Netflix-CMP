package com.codandotv.streamplayerapp.feature.profile.presentation.widget
...
private fun ProfileItem(
    state: com.codandotv.streamplayerapp.feature.profile.presentation.screens.ProfilePickerStreamsUIState,
    profileItemPosition: IntOffset,
    profile: com.codandotv.streamplayerapp.feature.profile.domain.ProfileStream,
    onClickSelectedProfile: (com.codandotv.streamplayerapp.feature.profile.domain.ProfileStream) -> Unit
) {
    with(state) {
        Column(
